...
import Darwinlogo from '../../assets/DarwinLogo.png'
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                ...
                Effortlessly recruit top talent with startup-friendly software
                </h1>
                <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
                Improve empowers your growing company to discover top talent
                through engaging skills assessments that resonate with candidates.
  ...
  return (
    <>
      <a href={href} className="flex w-full items-center justify-center">
        <img src={imgSrc} alt="Improve" className="h-15 w-full" />
      </a>
    </>
  );
};
            ...
            <div>
              ...
              >
                <ul className="block lg:flex">
                  ...
                  <ListItem NavLink="/#">Feature</ListItem>
